                    ...
                    <div class="panel-body">
                        ...
                        <table id="zctb" class="table table-bordered  dataTable" cellspacing="0" width="100%" border="1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="6">
                                    <?php echo "<img  style='border:3px solid black;text-align:center;height:150px;width:150px;margin-left:1400px' src='" . $row['std_img'] . "' height='100px' width='100px'>" ?>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td><?php $wop = $row['date_of_birth']; print date("d-m-Y",strtotime($wop))?></td>
                                </tr>

...
<div class="content">
<h1>Student Fee Payment Receipt</h1>
<hr>
<?php
  error_reporting(0);
          ...
          else
          {
              while ($row = mysqli_fetch_assoc($result)) 
              {
                  ...
                  <div class="panel panel-default">
                      ...
                      <a href="viewfeedetails.php" class="btn btn-danger">BACK</a>
                      <a href="../report-generate/printfeereceipt.php?enroll=<?php echo $row['enrollment']?> & year=<?php echo $row['pay_year']?>" class="btn btn-primary me-3 px-5 ">Generate Fee Receipt</a>
                      </div>
                      <?php
                  }
              }

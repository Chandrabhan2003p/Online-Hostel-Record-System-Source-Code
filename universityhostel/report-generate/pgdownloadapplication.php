        ...
        else
         {
            ...
            while ($row = mysqli_fetch_assoc($result)) 
            {
              ...
              <div class="box">
                    ...
                    <div class="panel-body">
                        ...
                        <table id="zctb" class="table table-bordered  dataTable" cellspacing="0" width="100%" border="1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="6">
                                    <?php echo "<img  style='border:3px solid black;text-align:center;height:150px;width:150px;margin-left:1900px' src='" . $row['std_img'] . "' height='100px' width='100px'>" ?>
                                    </td>
                                </tr>
                ...
                <a href="pgprintapplication.php?cuetno=<?php echo $row['cuet_no']?>" class="btn btn-primary me-3 px-5 ">Download Application</a>
              </div>
                <?php
            }
        }
